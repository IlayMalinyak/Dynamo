...
from dataset.planet_params import generate_planet_parameters
...
def main():
    ...
    parser.add_argument('--models_root', type=str, required=True,
                        help='Root directory containing stellar models')
    ...
    num_cpus = max(1, args.n_cpu)
    logger.info(f"Using {num_cpus} CPU cores for parallel processing")

    # Prepare arguments for multiprocessing
    args_list = [(args.models_root, i, row, args.dataset_dir, logger, args.ndays,
