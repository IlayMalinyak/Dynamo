...
#PHOTOMETRY
@nb.njit(cache=True,error_model='numpy')
def generate_rotating_photosphere_fast_lc(obs_times,
                                          Ngrid_in_ring,
                                          acd,amu,pare,flnp,
                                          flns,filter_trans,
                                          N,use_phoenix_mu,LD_law,
                                          LD1,LD2,spot_map,ref_time,
                                          Prot,diff_rot,Revo,Q,inc,
                                          temp_ph,temp_fc,simulate_planet,
                                          esinw,ecosw,T0p,Pp,Rpl,b,a,alp):
    ...
    return obs_times, flux/flxph, filling_ph, filling_sp, filling_fc, filling_pl, flp
